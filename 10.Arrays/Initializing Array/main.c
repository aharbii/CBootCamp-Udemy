...
int main()
{
    ...
    /* A sparse array is an array of data in which many elements 
    have a value of zero. This is in contrast to a dense array, 
    where most of the elements have non-zero values or are “full” 
    of numbers. A sparse array may be treated differently than a 
    ...
    int t[LEN] = {[0] = 5, 4, [LEN - 3] = 3, 2, 1};   // t has type int[5] and holds 5, 4, 0, 0, ......, 3, 2, 1  
